      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4">
            ...
            tool transforms your text into eye-catching images eith just a few
          ...
          <p className="text-gray-600 mb-4">
            ...
            characterdesigns and portraits,even concepts that dont't yet exist
            can be visualized effortlessly.Powered by advanced AI technology,the
